...
export class InspertorMgr {
    ...
    private static listeneNumberField(component: INodeComponent | I2DComponent | transform | transform2D, fieldInfo: IComponentFieldInfo): IAttributeData<IAttrComponent<NumberInputDataType>> {
    ...
    private static listeneVector2Field(component: INodeComponent | I2DComponent | transform | transform2D, fieldInfo: IComponentFieldInfo): IAttributeData<IAttrComponent<vector2>> {
