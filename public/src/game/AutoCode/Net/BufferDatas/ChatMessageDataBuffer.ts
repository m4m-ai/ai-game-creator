...
export class ChatMessageDataBuffer{

    public static get Instance(): ChatMessageDataBuffer {
        if (this._instance == null) {
            this._instance = new ChatMessageDataBuffer();
        }

        return this._instance;
    }
    private static _instance: ChatMessageDataBuffer;
...
getData["buttons"]=buttonsDic;getData["isOver"]=br.readBoolean();
getData["sendTime"]=br.readLong();
getData["jsonType"]=NetData.readString(br);
getData["jsondata"]=NetData.readString(br);
