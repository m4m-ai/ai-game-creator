...
export class ChatGuideManager {
    ...
    private static _instance = new ChatGuideManager();

    public aiGrideMessageMap: Map<ChatTabEnum, ChatGuide[]> = new Map();
    public init() {
        this.aiGrideMessageMap.set(ChatTabEnum.backgroundSetting, backgroundSettingGuideList);
        this.aiGrideMessageMap.set(ChatTabEnum.backgroundImage, backgroundImageGuideList);
