...
export class LanguageDataCNBuffer{

    public static get Instance(): LanguageDataCNBuffer {
        if (this._instance == null) {
            this._instance = new LanguageDataCNBuffer();
        }

        return this._instance;
    }
    private static _instance: LanguageDataCNBuffer;
