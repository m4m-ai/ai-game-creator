...
export class newUiBase {
    ...
    public show(arg?: any) {
        ...
        if(this.parentTrans)
        {
            layTran=this.parentTrans;
        }else
        {
            layTran = this.getParent();
        }
        this.pushToLayer();
        ...
        if (globalThis.window && this.onShow) {
            this.onShow(arg);
        }
        this.bind();
        if (this.noAffected) {
    ...
    public hide() {
        ...
        UiManager.OnHideDisposeUi(this.uiName,this);
    }
    public openLastUI(arg: any = null) {
        return UiManager.openLastUI(this.uiName, arg);
    }
    public getLastUI() {
        return UiManager.openLastUI(this.uiName, null, false);
    }
    public dispose() {
        console.log("dispose UI " + this.uiName);
        this.isShow = false;
        // this.uiLayer = uiLayerType.baselayer;
        // this.notHideOnOtherShow = false;
        if (this.onDispose) {
