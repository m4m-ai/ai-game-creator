...
import { PropertieType } from "./dataType/PropertieType";
import { LoaderManage } from "./LoaderManage";

//原小代写的 testReadTool 类
...
// tslint:disable-next-line: class-name
export class AssembleUIReadTool {
    public static classType = m4m["testReadTool"] = AssembleUIReadTool;
    ...
    public static async loadAssetBoundleFiles(urll: string, isOnlyExportOne: boolean = false) {
        ...
        let url = LoaderManage.CDNURL + urll;
...
if (m4m) {
    ...
    m4m["test"].testReadTool = AssembleUIReadTool;
}