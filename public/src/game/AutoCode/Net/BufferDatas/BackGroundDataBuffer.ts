...
export class BackGroundDataBuffer{

    public static get Instance(): BackGroundDataBuffer {
        if (this._instance == null) {
            this._instance = new BackGroundDataBuffer();
        }

        return this._instance;
    }
    private static _instance: BackGroundDataBuffer;
...
getData["BGName"]=NetData.readString(br);
getData["backStory"]=NetData.readString(br);
getData["resPath"]=NetData.readString(br);
