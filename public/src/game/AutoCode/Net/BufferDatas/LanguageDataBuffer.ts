...
export class LanguageDataBuffer{

    public static get Instance(): LanguageDataBuffer {
        if (this._instance == null) {
            this._instance = new LanguageDataBuffer();
        }

        return this._instance;
    }
    private static _instance: LanguageDataBuffer;
